...
const title = "HIGH-RISE BUILDING REGISTRATION";
const strapline = "End-to-end support registering higher-risk buildings and assembling the required key building information.";

export const Route = createFileRoute("/services/building-safety/high-rise-building-registration")({
  head: () => ({
    meta: [
...
function Page() {
  return (
    <ServicePage
      ...
      strapline={strapline}
      what={[
        "Placeholder overview: End-to-end support registering higher-risk buildings and assembling the required key building information.",
