...
const title = "MEASURED BUILDING HEIGHT SURVEYS";
const strapline = "Accurate, defensible building height measurement to confirm regulatory thresholds.";

export const Route = createFileRoute("/services/measured-building-height-surveys")({
  head: () => ({
    meta: [
...
function Page() {
  return (
    <ServicePage
      ...
      strapline={strapline}
      what={[
        "Placeholder overview: Accurate, defensible building height measurement to confirm regulatory thresholds.",
