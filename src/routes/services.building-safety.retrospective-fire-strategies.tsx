...
const title = "RETROSPECTIVE FIRE STRATEGIES";
const strapline = "Reconstructing the fire strategy for existing buildings where original design information is missing.";

export const Route = createFileRoute("/services/building-safety/retrospective-fire-strategies")({
  head: () => ({
    meta: [
...
function Page() {
  return (
    <ServicePage
      ...
      strapline={strapline}
      what={[
        "Placeholder overview: Reconstructing the fire strategy for existing buildings where original design information is missing.",
