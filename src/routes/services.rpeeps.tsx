...
const title = "RPEEPS";
const strapline = "Residential Personal Emergency Evacuation Plans for residents who may need assistance to evacuate.";

export const Route = createFileRoute("/services/rpeeps")({
  head: () => ({
    meta: [
...
function Page() {
  return (
    <ServicePage
      ...
      strapline={strapline}
      what={[
        "Placeholder overview: Residential Personal Emergency Evacuation Plans for residents who may need assistance to evacuate.",
