...
const title = "WAYFINDING SIGNAGE";
const strapline = "Compliant wayfinding signage schemes designed, specified and installed for residential blocks.";

export const Route = createFileRoute("/services/wayfinding-signage")({
  head: () => ({
    meta: [
...
function Page() {
  return (
    <ServicePage
      ...
      strapline={strapline}
      what={[
        "Placeholder overview: Compliant wayfinding signage schemes designed, specified and installed for residential blocks.",
