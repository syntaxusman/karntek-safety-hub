...
const title = "FIRE DOOR INSPECTIONS";
const strapline = "Flat entrance and communal fire door inspections carried out to the required statutory frequencies.";

export const Route = createFileRoute("/services/fire-door-inspections/")({
  head: () => ({
    meta: [
...
function Page() {
  return (
    <ServicePage
      ...
      strapline={strapline}
      what={[
        "Placeholder overview: Flat entrance and communal fire door inspections carried out to the required statutory frequencies.",
