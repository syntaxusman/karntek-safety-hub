...
const strapline = "Independent management of fire safety remediation projects from specification through to sign-off.";
...
function Page() {
  return (
    <ServicePage
      ...
      strapline={strapline}
      what={[
        "Placeholder overview: Independent management of fire safety remediation projects from specification through to sign-off.",
