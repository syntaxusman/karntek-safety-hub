...
const title = "RESIDENT ENGAGEMENT STRATEGIES";
const strapline = "Compliant, practical engagement strategies that give residents a real voice in building safety.";

export const Route = createFileRoute("/services/building-safety/resident-engagement-strategies")({
  head: () => ({
    meta: [
...
function Page() {
  return (
    <ServicePage
      ...
      strapline={strapline}
      what={[
        "Placeholder overview: Compliant, practical engagement strategies that give residents a real voice in building safety.",
