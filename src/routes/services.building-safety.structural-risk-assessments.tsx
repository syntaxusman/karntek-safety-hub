...
const title = "STRUCTURAL RISK ASSESSMENTS";
const strapline = "Independent appraisal of structural condition and risk across your residential portfolio.";

export const Route = createFileRoute("/services/building-safety/structural-risk-assessments")({
  head: () => ({
    meta: [
...
function Page() {
  return (
    <ServicePage
      ...
      strapline={strapline}
      what={[
        "Placeholder overview: Independent appraisal of structural condition and risk across your residential portfolio.",
